...
class LogradourosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create logradouro" do
    assert_difference('Logradouro.count') do
      post logradouros_url, params: { logradouro: { descricao: @logradouro.descricao, localizacao: @logradouro.localizacao } }
    end
  ...
  test "should update logradouro" do
    patch logradouro_url(@logradouro), params: { logradouro: { descricao: @logradouro.descricao, localizacao: @logradouro.localizacao } }
